const InstAccountConfig = require("./config/minAccountRequirements.config");
...
const getReferralLink = (userId) =>
    `https://t.me/bloggerup_bot?start=${userId}`;
...
module.exports = {
    commands: [
        ...
        {
            command: "policies",
            description: "Политики BloggerUP"
        },
        {
            command: "contacts",
    ...
    reply: {
        commands: {
            // start: [
            //     "Чтобы зарегистрироваться и начать бесплатное продвижение, введите ник Вашего Instagram аккаунта.",
            //     "Требования к вашей учетной записи:",
            //     "👤 аватар,",
            //     "🖼️ минимум медиа,"
            //     // `🖼️ минимум ${InstAccountConfig.minPhotos} медиа,`
            //     // `🧍 минимум ${InstAccountConfig.minFollowers} подписчиков,`
            //     `🙈 открытий профиль\n`,
            //     'ФЕЙКИ БУДУТ БЛОКИРОВАТЬСЯ 🔒\n',
            //     `Регистрируясь, я принимаю <a href="${helperConfig.termsForUseUrl}">Условия использования</a> и <a href="${helperConfig.privacyPolicyUrl}">Политику конфиденциальности</a> BloggerUP.`
            // ].join('\n'),
        ...
        messages: {
            ...
            newInstAccount: {
                ...
                fewSubscribers: `Недостаточно подпискиков!\nМинимальное количество: ${InstAccountConfig.minFollowers}. Введите ник аккаунта, который соответсвует минимальным требованиям:`,
                fewMedia: `Недостаточно медиа!\nМинимальное количество: ${InstAccountConfig.minPhotos}. Введите ник аккаунта, который соответсвует минимальным требованиям:`,
